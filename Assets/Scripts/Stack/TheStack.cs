...
public class TheStack : MonoBehaviour
{
    ...
    public int MaxCombo { get => maxCombo; } //람다
    ...
    bool PlaceBlock()
    {
        ...
        if(isMovingX)
        {
            ...
            if (deltaX > ErrorMargin)
            {
                ...
                float middle = (prevBlockPosition.x + lastPosition.x) / 2.0f;
        ...
        else
        {
            ...
            if (deltaZ > ErrorMargin)
            {
                ...
                float middle = (prevBlockPosition.z + lastPosition.z) / 2.0f;
                lastBlock.localScale = new Vector3(stackBounds.x, 1, stackBounds.y);
    ...
    void GameOverEffect()
    {
        ...
        for(int i = 1; i < 20; i++)
        {
            ...
            rigid.AddForce(
                (Vector3.up * Random.Range(0, 10f) + Vector3.right * (Random.Range(0, 10f) - 5.0f)) * 100f
            ); 
        }
    }
